...
class DescribePart:
    ...
    def it_can_be_constructed_by_PartFactory(self, package_: Mock, init__: Mock) -> None:
        part = Part.load(PackURI("/part/name"), "content/type", b"1be2", cast(Package, package_))

        init__.assert_called_once_with(ANY, "/part/name", "content/type", b"1be2", package_)
        assert isinstance(part, Part)

    def it_knows_its_partname(self) -> None:
        part = Part(PackURI("/part/name"), "content/type")
        assert part.partname == "/part/name"

    def it_can_change_its_partname(self) -> None:
        part = Part(PackURI("/old/part/name"), "content/type")
        part.partname = PackURI("/new/part/name")
        assert part.partname == "/new/part/name"

    def it_knows_its_content_type(self) -> None:
        part = Part(PackURI("/part/name"), "content/type")
        assert part.content_type == "content/type"

    def it_knows_the_package_it_belongs_to(self, package_: Mock) -> None:
        part = Part(PackURI("/part/name"), "content/type", package=cast(Package, package_))
        assert part.package is package_

    def it_can_be_notified_after_unmarshalling_is_complete(self) -> None:
        part = Part(PackURI("/part/name"), "content/type")
        part.after_unmarshal()

    def it_can_be_notified_before_marshalling_is_started(self) -> None:
        part = Part(PackURI("/part/name"), "content/type")
        part.before_marshal()

    def it_uses_the_load_blob_as_its_blob(self) -> None:
        blob = b"abcde"
    ...
    @pytest.fixture
    def init__(self, request: FixtureRequest) -> Mock:
...
class DescribePartRelationshipManagementInterface:
    ...
    def it_can_load_a_relationship(self, rels_prop_: Mock, rels_: Mock, other_part_: Mock) -> None:
        rels_prop_.return_value = rels_
        part = Part(cast(PackURI, "partname"), "content_type")
    ...
    def it_can_establish_an_external_relationship(self, rels_prop_: Mock, rels_: Mock) -> None:
        rels_prop_.return_value = rels_
    ...
    def it_can_drop_a_relationship(self, rels_prop_: Mock) -> None:
    ...
    @pytest.fixture
    def other_part_(self, request: FixtureRequest) -> Mock:
...
class DescribePartFactory:
    def it_constructs_part_from_selector_if_defined(
        self, cls_selector_fixture: tuple[Mock, tuple[Mock, Mock, Mock, Mock, Mock], Mock, Mock]
    ) -> None:
        # fixture ----------------------
        (
            cls_selector_fn_,
    ...
    def it_constructs_custom_part_type_for_registered_content_types(
        self,
        part_args_: tuple[Mock, Mock, Mock, Mock, Mock],
        CustomPartClass_: Mock,
        part_of_custom_type_: Mock,
    ) -> None:
        # fixture ----------------------
        partname, content_type, reltype, package, blob = part_args_
        # exercise ---------------------
        PartFactory.part_type_for[content_type] = cast("type[Part]", CustomPartClass_)
        part = PartFactory(partname, content_type, reltype, blob, package)
        # verify -----------------------
        CustomPartClass_.load.assert_called_once_with(partname, content_type, blob, package)
        assert part is part_of_custom_type_
    ...
    def it_constructs_part_using_default_class_when_no_custom_registered(
        self,
        part_args_2_: tuple[Mock, Mock, Mock, Mock, Mock],
        DefaultPartClass_: Mock,
        part_of_default_type_: Mock,
    ) -> None:
    ...
    @pytest.fixture
    def blob_2_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, str)

    @pytest.fixture
    def cls_method_fn_(self, request: FixtureRequest, cls_selector_fn_: Mock) -> Mock:
        return function_mock(request, "docx.opc.part.cls_method_fn", return_value=cls_selector_fn_)

    @pytest.fixture
    def cls_selector_fixture(
        self,
        cls_selector_fn_: Mock,
        cls_method_fn_: Mock,
        part_load_params: tuple[Mock, Mock, Mock, Mock, Mock],
        CustomPartClass_: Mock,
        part_of_custom_type_: Mock,
    ) -> Iterator[tuple[Mock, tuple[Mock, Mock, Mock, Mock, Mock], Mock, Mock]]:
    ...
    @pytest.fixture
    def cls_selector_fn_(self, request: FixtureRequest, CustomPartClass_: Mock) -> Mock:
    ...
    @pytest.fixture
    def content_type_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, str)

    @pytest.fixture
    def content_type_2_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, str)

    @pytest.fixture
    def CustomPartClass_(self, request: FixtureRequest, part_of_custom_type_: Mock) -> Mock:
    ...
    @pytest.fixture
    def DefaultPartClass_(self, request: FixtureRequest, part_of_default_type_: Mock) -> Mock:
    ...
    @pytest.fixture
    def package_2_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, OpcPackage)
    ...
    @pytest.fixture
    def part_of_custom_type_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, Part)

    @pytest.fixture
    def part_of_default_type_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, Part)
    ...
    @pytest.fixture
    def partname_2_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, PackURI)
    ...
    @pytest.fixture
    def reltype_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, str)

    @pytest.fixture
    def reltype_2_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, str)
...
class DescribeXmlPart:
    ...
    def it_can_serialize_to_xml(self, blob_fixture: tuple[XmlPart, Mock, Mock]) -> None:
    ...
    def it_knows_its_the_part_for_its_child_objects(self, part_fixture: XmlPart) -> None:
    ...
    @pytest.fixture
    def blob_fixture(
        self, request: FixtureRequest, element_: Mock, serialize_part_xml_: Mock
    ) -> tuple[XmlPart, Mock, Mock]:
        xml_part = XmlPart(cast(PackURI, None), cast(str, None), element_, cast(Package, None))
        return xml_part, element_, serialize_part_xml_

    @pytest.fixture
    def part_fixture(self) -> XmlPart:
        return XmlPart(
            cast(PackURI, None),
            cast(str, None),
            cast(BaseOxmlElement, None),
            cast(Package, None),
        )
    ...
    @pytest.fixture
    def element_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, BaseOxmlElement)

    @pytest.fixture
    def XmlPart__init_(self, request: FixtureRequest) -> Mock:
    ...
    @pytest.fixture
    def parse_xml_(self, request: FixtureRequest, element_: Mock) -> Mock:
    ...
    @pytest.fixture
    def serialize_part_xml_(self, request: FixtureRequest) -> Mock:
