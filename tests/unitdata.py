...
class BaseBuilder:
    ...
    def __init__(self) -> None:
        ...
        self._nsdecls = ""
        self._text = ""
        self._xmlattrs: List[str] = []
        self._xmlattr_method_map: dict[str, str] = {}
        ...
        self._child_bldrs: List[BaseBuilder] = []
    ...
    def __getattr__(self, name: str) -> Callable[[Any], Self]:
        ...
        if name in self._xmlattr_method_map:
            ...
            def with_xmlattr(value: Any) -> Self:
    ...
    def with_child(self, child_bldr: BaseBuilder) -> Self:
        """
    ...
    def xml_bytes(self, indent: int = 0) -> bytes:
        return self.xml(indent=indent).encode("utf-8")

    @property
    def _empty_element_tag(self) -> str:
    ...
    def _non_empty_element_xml(self, indent: int) -> str:
        indent_str = " " * indent
        if self._text:
    ...
    def _set_xmlattr(self, xmlattr_name: str, value: Any) -> None:
