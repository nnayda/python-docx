...
class DescribeFooterPart:
    def it_is_used_by_loader_to_construct_footer_part(
        self, package_: Mock, FooterPart_load_: Mock, footer_part_: Mock
    ) -> None:
    ...
    def it_can_create_a_new_footer_part(
        self, package_: Mock, _default_footer_xml_: Mock, parse_xml_: Mock, _init_: Mock
    ) -> None:
        ftr = element("w:ftr")
    ...
    def it_loads_default_footer_XML_from_a_template_to_help(self) -> None:
    ...
    @pytest.fixture
    def _default_footer_xml_(self, request: FixtureRequest) -> Mock:
    ...
    @pytest.fixture
    def FooterPart_load_(self, request: FixtureRequest) -> Mock:
...
class DescribeHeaderPart:
    def it_is_used_by_loader_to_construct_header_part(
        self, package_: Mock, HeaderPart_load_: Mock, header_part_: Mock
    ) -> None:
    ...
    def it_can_create_a_new_header_part(
        self, package_: Mock, _default_header_xml_: Mock, parse_xml_: Mock, _init_: Mock
    ) -> None:
        hdr = element("w:hdr")
    ...
    def it_loads_default_header_XML_from_a_template_to_help(self) -> None:
        # ---tests integration with OS---
    ...
    @pytest.fixture
    def _default_header_xml_(self, request: FixtureRequest) -> Mock:
        return method_mock(request, HeaderPart, "_default_header_xml", autospec=False)

    @pytest.fixture
    def HeaderPart_load_(self, request: FixtureRequest) -> Mock:
