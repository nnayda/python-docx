...
class DescribeStoryPart:
    def it_can_get_or_add_an_image(
        self, package_: Mock, image_part_: Mock, image_: Mock, relate_to_: Mock
    ) -> None:
        ...
        story_part = StoryPart(
            cast(PackURI, None), cast(str, None), cast(BaseOxmlElement, None), package_
        )
    ...
    def it_can_get_a_style_by_id_and_type(
        self, _document_part_prop_: Mock, document_part_: Mock, style_: Mock
    ) -> None:
        style_id = "BodyText"
        ...
        story_part = StoryPart(
            cast(PackURI, None), cast(str, None), cast(BaseOxmlElement, None), cast(Package, None)
        )
    ...
    def it_can_create_a_new_pic_inline(
        self, get_or_add_image_: Mock, image_: Mock, next_id_prop_: Mock
    ) -> None:
    ...
    def it_knows_the_next_available_xml_id(
        self, next_id_fixture: tuple[BaseOxmlElement, int]
    ) -> None:
        story_element, expected_value = next_id_fixture
        story_part = StoryPart(
            cast(PackURI, None), cast(str, None), story_element, cast(Package, None)
        )
    ...
    def it_knows_the_main_document_part_to_help(self, package_: Mock, document_part_: Mock) -> None:
    ...
    def next_id_fixture(self, request: FixtureRequest) -> tuple[BaseOxmlElement, int]:
        story_cxml, expected_value = cast("tuple[str, int]", request.param)
    ...
    @pytest.fixture
    def _document_part_prop_(self, request: FixtureRequest) -> Mock:
        return property_mock(request, StoryPart, "_document_part")

    @pytest.fixture
    def get_or_add_image_(self, request: FixtureRequest) -> Mock:
    ...
    @pytest.fixture
    def next_id_prop_(self, request: FixtureRequest) -> Mock:
