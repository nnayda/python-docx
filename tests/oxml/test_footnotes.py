...
class DescribeCT_Footnotes:
    ...
    def it_calculates_the_next_id_ignoring_separators(self):
        footnotes = cast(
            CT_Footnotes,
    ...
    def it_starts_ids_at_one_when_only_separators_present(self):
        footnotes = cast(
            CT_Footnotes,
    ...
    def it_can_add_a_footnote_with_a_given_id(self):
...
class DescribeCT_FtnEdn:
    ...
    def it_knows_its_type_when_present(self):
