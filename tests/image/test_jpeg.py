...
class DescribeJpeg:
    def it_knows_its_content_type(self):
        jpeg = Jpeg(cast(int, None), cast(int, None), cast(int, None), cast(int, None))
    ...
    class DescribeExif:
        def it_can_construct_from_an_exif_stream(
            self, from_exif_fixture: tuple[Mock, Mock, int, int, int, int]
        ):
            # fixture ----------------------
    ...
    class DescribeJfif:
        def it_can_construct_from_a_jfif_stream(
            self, from_jfif_fixture: tuple[Mock, Mock, int, int, int, int]
        ):
    ...
    @pytest.fixture
    def from_exif_fixture(
        self, stream_: Mock, _JfifMarkers_: Mock, jfif_markers_: Mock
    ) -> tuple[Mock, Mock, int, int, int, int]:
    ...
    @pytest.fixture
    def _JfifMarkers_(self, request: FixtureRequest, jfif_markers_: Mock) -> Mock:
    ...
    @pytest.fixture
    def jfif_markers_(self, request: FixtureRequest) -> Mock:
...
class Describe_JfifMarkers:
    ...
    def it_can_find_the_APP0_marker(self, app0_fixture: tuple[_JfifMarkers, Mock]):
        jfif_markers, app0_ = app0_fixture
        app0 = jfif_markers.app0
        assert app0 is app0_

    def it_can_find_the_APP1_marker(self, app1_fixture: tuple[_JfifMarkers, Mock]):
        jfif_markers, app1_ = app1_fixture
        app1 = jfif_markers.app1
        assert app1 is app1_

    def it_raises_if_it_cant_find_the_APP0_marker(self, no_app0_fixture: _JfifMarkers):
        jfif_markers = no_app0_fixture
        with pytest.raises(KeyError):
            jfif_markers.app0

    def it_raises_if_it_cant_find_the_APP1_marker(self, no_app1_fixture: _JfifMarkers):
        jfif_markers = no_app1_fixture
        with pytest.raises(KeyError):
            jfif_markers.app1

    def it_can_find_the_SOF_marker(self, sof_fixture: tuple[_JfifMarkers, Mock]):
        jfif_markers, sof_ = sof_fixture
        sof = jfif_markers.sof
        assert sof is sof_

    def it_raises_if_it_cant_find_the_SOF_marker(self, no_sof_fixture: _JfifMarkers):
    ...
    @pytest.fixture
    def app0_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, _App0Marker, marker_code=JPEG_MARKER_CODE.APP0)

    @pytest.fixture
    def app1_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, _App1Marker, marker_code=JPEG_MARKER_CODE.APP1)

    @pytest.fixture
    def app0_fixture(self, soi_: Mock, app0_: Mock, eoi_: Mock) -> tuple[_JfifMarkers, Mock]:
        markers = (soi_, app0_, eoi_)
        jfif_markers = _JfifMarkers(markers)
        return jfif_markers, app0_

    @pytest.fixture
    def app1_fixture(self, soi_: Mock, app1_: Mock, eoi_: Mock) -> tuple[_JfifMarkers, Mock]:
        markers = (soi_, app1_, eoi_)
        jfif_markers = _JfifMarkers(markers)
        return jfif_markers, app1_

    @pytest.fixture
    def eoi_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, _SofMarker, marker_code=JPEG_MARKER_CODE.EOI)

    @pytest.fixture
    def _JfifMarkers__init_(self, request: FixtureRequest) -> Mock:
        return initializer_mock(request, _JfifMarkers)

    @pytest.fixture
    def marker_parser_(self, request: FixtureRequest, markers_all_: list[Mock]) -> Mock:
    ...
    @pytest.fixture
    def _MarkerParser_(self, request: FixtureRequest, marker_parser_: Mock) -> Mock:
    ...
    @pytest.fixture
    def no_app0_fixture(self, soi_: Mock, eoi_: Mock) -> _JfifMarkers:
        markers = (soi_, eoi_)
        return _JfifMarkers(markers)

    @pytest.fixture
    def no_app1_fixture(self, soi_: Mock, eoi_: Mock) -> _JfifMarkers:
        markers = (soi_, eoi_)
        return _JfifMarkers(markers)

    @pytest.fixture
    def no_sof_fixture(self, soi_: Mock, eoi_: Mock) -> _JfifMarkers:
        markers = (soi_, eoi_)
        return _JfifMarkers(markers)

    @pytest.fixture
    def sof_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, _SofMarker, marker_code=JPEG_MARKER_CODE.SOF0)

    @pytest.fixture
    def sof_fixture(self, soi_: Mock, sof_: Mock, eoi_: Mock) -> tuple[_JfifMarkers, Mock]:
        markers = (soi_, sof_, eoi_)
        jfif_markers = _JfifMarkers(markers)
        return jfif_markers, sof_

    @pytest.fixture
    def soi_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, _Marker, marker_code=JPEG_MARKER_CODE.SOI)

    @pytest.fixture
    def sos_(self, request: FixtureRequest) -> Mock:
...
class Describe_Marker:
    def it_can_construct_from_a_stream_and_offset(
        self, from_stream_fixture: tuple[StreamReader, bytes, int, Mock, int]
    ):
    ...
    def from_stream_fixture(
        self, request: FixtureRequest, _Marker__init_: Mock
    ) -> tuple[StreamReader, bytes, int, Mock, int]:
        marker_code, offset, length = cast("tuple[bytes, int, int]", request.param)
    ...
    @pytest.fixture
    def _Marker__init_(self, request: FixtureRequest) -> Mock:
        return initializer_mock(request, _Marker)


class Describe_App0Marker:
    def it_can_construct_from_a_stream_and_offset(self, _App0Marker__init_: Mock):
    ...
    def it_knows_the_image_dpi(self, dpi_fixture: tuple[int, int, int, int, int]):
    ...
    @pytest.fixture
    def _App0Marker__init_(self, request: FixtureRequest) -> Mock:
    ...
    def dpi_fixture(self, request: FixtureRequest) -> tuple[int, int, int, int, int]:
        density_units, x_density, y_density, horz_dpi, vert_dpi = cast(
            "tuple[int, int, int, int, int]", request.param
        )
...
class Describe_App1Marker:
    def it_can_construct_from_a_stream_and_offset(
        self, _App1Marker__init_: Mock, _tiff_from_exif_segment_: Mock
    ):
    ...
    def it_can_construct_from_non_Exif_APP1_segment(self, _App1Marker__init_: Mock):
    ...
    def it_gets_a_tiff_from_its_Exif_segment_to_help_construct(
        self,
        get_tiff_fixture: tuple[StreamReader, int, int, Mock, bytes, Mock, Mock, Mock],
    ):
    ...
    def it_knows_the_image_dpi(self):
        horz_dpi, vert_dpi = 42, 24
        app1 = _App1Marker(cast(bytes, None), cast(int, None), cast(int, None), horz_dpi, vert_dpi)
    ...
    @pytest.fixture
    def _App1Marker__init_(self, request: FixtureRequest) -> Mock:
        return initializer_mock(request, _App1Marker)

    @pytest.fixture
    def get_tiff_fixture(
        self, request: FixtureRequest, substream_: Mock, Tiff_: Mock, tiff_: Mock
    ) -> tuple[StreamReader, int, int, Mock, bytes, Mock, Mock, Mock]:
    ...
    @pytest.fixture
    def substream_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, io.BytesIO)

    @pytest.fixture
    def Tiff_(self, request: FixtureRequest, tiff_: Mock) -> Mock:
        Tiff_ = class_mock(request, "docx.image.jpeg.Tiff")
        Tiff_.from_stream.return_value = tiff_
        return Tiff_

    @pytest.fixture
    def tiff_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, Tiff, horz_dpi=42, vert_dpi=24)

    @pytest.fixture
    def _tiff_from_exif_segment_(self, request: FixtureRequest, tiff_: Mock) -> Mock:
        return method_mock(
            request,
            _App1Marker,
...
class Describe_SofMarker:
    def it_can_construct_from_a_stream_and_offset(
        self, request: FixtureRequest, _SofMarker__init_: Mock
    ):
    ...
    def it_knows_the_image_width_and_height(self):
        sof = _SofMarker(cast(bytes, None), cast(int, None), cast(int, None), 42, 24)
    ...
    @pytest.fixture
    def _SofMarker__init_(self, request: FixtureRequest) -> Mock:
        return initializer_mock(request, _SofMarker)


class Describe_MarkerFactory:
    def it_constructs_the_appropriate_marker_object(
        self, call_fixture: tuple[bytes, Mock, Mock, Mock]
    ):
    ...
    def call_fixture(
        ...
        _SofMarker_: Mock,
        _Marker_: Mock,
    ) -> tuple[bytes, Mock, Mock, Mock]:
        marker_code = cast(bytes, request.param)
    ...
    @pytest.fixture
    def _App0Marker_(self, request: FixtureRequest) -> Mock:
        return class_mock(request, "docx.image.jpeg._App0Marker")

    @pytest.fixture
    def _App1Marker_(self, request: FixtureRequest) -> Mock:
        return class_mock(request, "docx.image.jpeg._App1Marker")

    @pytest.fixture
    def _Marker_(self, request: FixtureRequest) -> Mock:
    ...
    @pytest.fixture
    def _SofMarker_(self, request: FixtureRequest) -> Mock:
...
class Describe_MarkerFinder:
    def it_can_construct_from_a_stream(self, stream_: Mock, _MarkerFinder__init_: Mock):
    ...
    def it_can_find_the_next_marker_after_a_given_offset(
        self, next_fixture: tuple[_MarkerFinder, int, tuple[bytes, int]]
    ):
    ...
    @pytest.fixture
    def _MarkerFinder__init_(self, request: FixtureRequest) -> Mock:
    ...
    def next_fixture(self, request: FixtureRequest) -> tuple[_MarkerFinder, int, tuple[bytes, int]]:
        start, marker_code, segment_offset = cast("tuple[int, bytes, int]", request.param)
...
class Describe_MarkerParser:
    ...
    def it_can_iterate_over_the_jfif_markers_in_its_stream(
        self,
        iter_markers_fixture: tuple[
            _MarkerParser, Mock, Mock, Mock, Mock, list[bytes], list[int], list[Mock]
        ],
    ):
        (
            marker_parser,
    ...
    def iter_markers_fixture(
        ...
        _MarkerFinder_: Mock,
        marker_finder_: Mock,
        _MarkerFactory_: Mock,
        soi_: Mock,
        app0_: Mock,
        eoi_: Mock,
    ) -> tuple[_MarkerParser, Mock, Mock, Mock, Mock, list[bytes], list[int], list[Mock]]:
    ...
    @pytest.fixture
    def _MarkerFactory_(self, request: FixtureRequest, soi_: Mock, app0_: Mock, eoi_: Mock) -> Mock:
        return class_mock(
            request, "docx.image.jpeg._MarkerFactory", side_effect=[soi_, app0_, eoi_]
        )

    @pytest.fixture
    def _MarkerFinder_(self, request: FixtureRequest, marker_finder_: Mock) -> Mock:
    ...
    @pytest.fixture
    def marker_finder_(self, request: FixtureRequest) -> Mock:
        return instance_mock(request, _MarkerFinder)

    @pytest.fixture
    def _MarkerParser__init_(self, request: FixtureRequest) -> Mock:
    ...
    @pytest.fixture
    def StreamReader_(self, request: FixtureRequest, stream_reader_: Mock) -> Mock:
        return class_mock(request, "docx.image.jpeg.StreamReader", return_value=stream_reader_)

    @pytest.fixture
    def stream_reader_(self, request: FixtureRequest) -> Mock:
